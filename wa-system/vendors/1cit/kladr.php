...
class KladrApi
{
        const OurToken = '58d0fb710a69de24088b456b';
	...
	private function GetURL(KladrQuery $query)
	{
		if (empty($this->token)) {
	 ...
	 * @return bool|mixed
	 */
	public function QueryToJson(KladrQuery $query, $assoc = FALSE)
	{
	 ...
	 * @return array
	 */
	public function QueryToArray(KladrQuery $query)
	{
	 ...
	 * @return \Kladr\Object[]
	 */
	public function QueryToObjects(KladrQuery $query)
	{
